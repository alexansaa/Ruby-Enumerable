...
> Try out your own ruby enumerable!
...
- **[Enumerate array items with Ruby native code features]**
...
Welcome to Ruby Enumerable! Follow these steps to get your project up and running.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/alexansaa/Ruby-Enumerable
   cd your-project
